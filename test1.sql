...
--   `id` int(10) NOT NULL,
--   `name` varchar(50) NOT NULL,
--   `day` enum('UI UX','Front design','Product document','Software test','Research','Data Collection','Data cleaning') NOT NULL,
--   `DueData` time(6) NOT NULL,
...
CREATE TABLE `time` (
  `id` int(10) NOT NULL,
  `name` varchar(50) NOT NULL,
  `task` enum('UI UX','Front design','Product document','Software test','Research','Data Collection','Data cleaning') NOT NULL,
  `DueData` datetime(6) NOT NULL,
  `Done` varchar(20) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
